...
整組就是拿 Mac 平常接的 Magic Keyboard 去接好幾年前的老 iPad Pro，再接虛擬終端機連回 Mac mini，就算是行動網路也一樣順暢。整體重量比鍵盤殼輕很多，終端機要用滑鼠的場景本來就不多。深山野嶺也要 Claude Code。
...
<!--
新增非原文句子清單（忠實度自首）：
1. 「整組就是」 — 類型：併入碎念（iPad 加鍵盤是旅遊生產力最佳組合，2026-08-14 週報併入）
-->
