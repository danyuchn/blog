...
tags:
  ...
  - ai-tools
  - micro-notes
description: "2026 年較零碎、時效性的 AI 碎念，依時間排列。精選碎念（依主題分類）見主頁。"
---

這是 2026 年較零碎、時效性較強的 AI 碎念，依時間排列存檔。更精選、依主題分類的碎念請見[主頁](/posts/zh/ai-micro-notes)。
...
> 經典的 Google：一開始佛心讓你上鉤，然後砍額度、砍品質、用各種創意坑客戶。跟台灣銀行的信用卡套路九成像。
...
> 有中國網友拿 Opus 4.6 大戰 360，結果是 360 獲勝。你就知道 360 的技術（劫持）力了。

## 2026 年 7 月上旬（W27）

**Herdr 比 Tmux 好用**

> Herdr 比 Tmux 好用多了，望周知。

**又一個不讀系統卡的**

> Sonnet 5 一出，滿街都是不讀系統卡就開始評論的人。又一個不讀系統卡的。

## 2026 年 7 月上旬（W28）

**突然慷慨起來**

> 又是主動 reset，又是主動還過期的 credit。沒有任何理由，我能想到的唯一理由就是看到 GPT-5.6 發布，急了。
...
> 五張 RTX Pro 6000 在家跑 744B 模型、Claude 用量上限的錯誤繞道、企業因成本砍 AI 預算。本週 AgentCrew Academy 社群短報：<https://youtu.be/KUo6eOZepN0>

**Claude Code 2.1.201 三個修復**

> 睡眠喚醒後背景任務斷線、背景 agent 鎖死、語音輸入誤報連線失敗，這版一次修掉。更新速覽：<https://youtu.be/ZtZKP0Sc-Tk>

## 2026 年 7 月下旬（W31）

**Google 工程師的正確姿勢**

> 本週末最新笑料承包：Google 工程師要跟高職學學 AI 正確姿勢，5000 跑本地大模型。如果這是真的話，那下禮拜台股、SK 海力士、三星還不繼續跌爛。

**Fable 訂閱到期倒數的溫情戲碼**

> A：「Fable 只能用到 7/12 哦」（隔壁出新模型，大家覺得不錯想改訂閱）「誒誒，別走，幫你延到 7/19 啦」。
...
> 聽說今晚有 Opus 5，另外聽說 Codex 要把最近那個可以雙向對話的即時語音模型拉進來了。以後就真的是張嘴就罵 AI Agent 了。

**GPT 5.6 Sol 是瘋狗**

> 我都跟別人說，GPT 5.6 Sol 是瘋狗。當你給他 /狗死 下去（我還會順便放音樂，LISA 的「狗死～狗死～」），他就會死死咬著目標把它做完，不做完不罷休。

**1000 個 subagent vs HTML 文檔**
...
> Opus 5 上週上線，本來想說他們很勇敢。後來想一想，Claude 一到日都有 outage 過，他們壓根就不在乎 uptime。

**一邊瘋狂 reset，一邊瘋狂封鎖**

> 這幾天一邊瘋狂 reset，另一邊瘋狂封鎖帳號，簡直是我見過最荒謬的場景。

**禁未成年的雙標**

> 我覺得 Anthropic 這有點雙標。如果真的要禁未成年的話，他們自己的工程師就應該都不能用了——一個個心智都未成年。

**iPad 加鍵盤是旅遊生產力最佳組合**

> 拿 Mac 平常接的 Magic Keyboard 去接好幾年前的老 iPad Pro，再接虛擬終端機連回 Mac mini，就算是行動網路也一樣順暢。整體重量比鍵盤殼輕很多，終端機要用滑鼠的場景本來就不多。深山野嶺也要 Claude Code。

**Mac mini 保值不是騙人的**

> Mac mini M4 Pro 48GB，五月買五萬多還含 AppleCare，那是漲價前加員工價，現在去看要九萬多。電腦是生產力工具，用了幾年還能保值這句話不是騙人的。
...
> Cowork 的沙盒體驗，個人覺得還是不夠成熟。隔壁棚的 ChatGPT Work 就好很多。

**兩個永遠走不出來的地方**

> 兩個永遠迷路走不出來的地方：一、東京新宿車站。二、Meta 的 Business Manager。
...
> 我願稱你為 Context Rot 之王。

**東南亞的審美**

> 東南亞的審美是很不錯的，比如我大泰國，美學與設計獨樹一格，我覺得是亞洲可以跟日本並行的翹楚。
