...
說到這台機器的成本，Mac mini M4 Pro 48GB，五月買五萬多還含 AppleCare，那是漲價前加員工價，現在去看要九萬多。電腦是生產力工具，用了幾年還能保值這句話不是騙人的。
...
17. 「說到這台機器的成本，」 — 類型：併入碎念（Mac mini 保值不是騙人的，2026-08-14 週報併入）
18. 各 H2 小標（「先用文言文宣布了選型」「各任務用哪一支」「真正的瓶頸不是選型」「硬體跟成本的現實」「三大劣根性」） — 類型：框架句
-->
