...
**/loop 指令**
> Claude Code 最新版本的新指令 `/loop` 也太讚了吧！跟工作夥伴有部分還是在 Messenger 私人帳號上溝通，但是 Meta 沒辦法幫私人帳號接 API，所以我原本都是用截圖或複製訊息貼上。現在有 `/loop` 可以自動循環執行任務了。

![Claude Code /loop 指令](/blog/images/micro-notes/iqos-hack.jpg)

**Google Map MCP**
> Anthropic 官方出的 Google Map MCP，真好用。
...
**Obsidian + Mirror 框架做反思週報**
> 我的 Obsidian vault 裡面存放了日記、工作日誌、靈感、想法、各專案的連結、所有大大小小待辦事項。我常常問 Claude「今天我要做什麼」，然後每個禮拜還會用 Mirror 框架做反思週報——上個禮拜自己的軌跡跟生涯目標是否符合、什麼是最不願面對的教訓（比如拖延症），再用原子習慣搭配給下週改善的建議。
