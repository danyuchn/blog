...
<!--
自首清單
1. 「（新增 H2「憤怒式審查」及其段落）大家都在說讓 Claude 叫 Codex 來做「對抗式審查」挑刺，但總感覺差點意思。想到一個全新的審查思路：直接接入 Threads API，給他發文權限，想到解法就立刻用炫耀自己 Vibe 了什麼的 AI 語氣發在脆上面，保證馬上就有幾十個資深的鍵盤工程師出來，在留言免費幫你憤怒式審查。」 — 類型：併入碎念（憤怒式審查，2026-08-14 週報併入）
-->
