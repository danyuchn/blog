...
然後直接開一個新 session，`/goal` 下去。Opus 5.5 在這種長上下文長時間任務上的表現據說超級好。
...
<!--
2026-09-24 W40 補記：2026-09-23 Threads 貼文逐字併入。新增非原文句子：小標（框架句）。提示詞本體改為 blockquote，原文「開的表現」疑為錯字，改為「的表現」；「超 級 好」的空格強調改為「超級好」。
-->
