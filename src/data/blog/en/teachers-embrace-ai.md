...
1. Collect all your teaching materials -- videos, articles, course notes -- dump everything into one folder.
2. Write a script with the Gemini API to automatically transcribe all your teaching materials and do a rough categorization by content.
3. Once the categories look right, start distilling. Strip away the filler, keep only the teaching essence. My own 800,000 characters across 350+ files distilled down to 120,000 characters across 50-something files.
4. Go back and compare against the originals to make sure nothing important got lost in distillation.
