...
tags:
  ...
  - enterprise-ai
  - teaching
description: Four things I learned after running a handful of enterprise AI training sessions. Prep time is 3-5x the session itself. The client liaison decides everything. The instructor has to handle wildly different skill levels. And if you're looking to hire a trainer, the signals are like picking a pop star.
---
...
- Precall before class to align needs
- Cross-check whether those needs conflict with the company's policies or infra in practice
- Prepare distinct tasks, opening prompts, and Skill templates for each person
- Annotate slides with each person's name as a cue
...
- The first Precall must clarify "what I deliver, what I don't deliver"
- Walk them through "my plan is this, what's your most critical need—A or B?" Lead them to choose, instead of letting them vaguely say "both"
- Halfway through, proactively send work-in-progress (lesson outline, slide skeleton) when the price can still be adjusted, so they can give feedback at the cheap stage
...
- An admin manager who's never touched AI
- An engineer who has self-taught for three months and will ask you about hook internals
- A researcher whose IT policy bans Claude Code installation
- A mid-level manager wondering "will AI replace me?" (this question is actually meant for the leadership upstairs, not for you to answer here)
