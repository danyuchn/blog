...
An even more extreme example was the running joke a while back: a Google engineer needs to learn proper AI form from vocational school kids, running local models on a 5000 (NT dollar) machine. If that's true, Taiwan stocks, SK Hynix, and Samsung are in for another beating next week.
...
6. 「An even more extreme example was the running joke a while back:」 — 類型：併入碎念（A Google Engineer's Proper Form，2026-08-14 週報併入）
-->
