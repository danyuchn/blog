...
title: "A July Full of Resets: A Light AI User Reviews the Subsidy War"
slug: en/july-of-resets-subsidy-war
featured: false
draft: false
tags:
  - ai-economics
  - subscription
  - token-optimization
description: 'Every time a reset landed in July I used it to the last drop, and the ledger says 57.5x. Plus notes on the subsidy war, Deepseek''s price hike, and my bet on the next reset.'
---
...
![Screenshot of the ccusage table for all of July, totaling 233 million input tokens and 61.19 million output tokens, worth $11,501.51; the Claude row accounts for $7,415.12 and the Codex row for $4,086.39](/blog/assets/posts/july-of-resets-subsidy-war/1-july-usage.jpg)
...
Further routing I plan to do: non-sensitive information, or via local...
...
1. "A light AI user here, reviewing how this 'July full of resets' went." — type: rewrite (source sentence with the trailing colon dropped)
2. "## What I'm already actively doing" — type: framing (the bullet's opening phrase turned into a section heading)
3. "## That Deepseek chart may be obsolete soon" — type: framing (heading generated from that section's content)
4. "## On resets themselves" — type: framing (section divider only)
5. "So" in "So I'm putting this on record" — type: transition
6. "Another gut feeling:" — type: transition
